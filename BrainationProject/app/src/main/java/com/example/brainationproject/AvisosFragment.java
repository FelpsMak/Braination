...
public class AvisosFragment extends Fragment implements RecyclerViewOnClickListenerHack {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.rv_list_avisos);



        databaseReference = FirebaseDatabase.getInstance().getReference("Pessoa");
        databaseReference.child(auth.getUid().toString()).child("Avisos").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    for (DataSnapshot dado : snapshot.getChildren()){
                        String texto = dado.child("texto").getValue().toString();
                    ...
                    mRecyclerView.setAdapter(avisosAdapter);
                }
            }
